var vo=Object.defineProperty;var cr=t=>{throw TypeError(t)};var wo=(t,e,n)=>e in t?vo(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var Xt=(t,e,n)=>wo(t,typeof e!="symbol"?e+"":e,n),sn=(t,e,n)=>e.has(t)||cr("Cannot "+n);var G=(t,e,n)=>(sn(t,e,"read from private field"),n?n.call(t):e.get(t)),q=(t,e,n)=>e.has(t)?cr("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,n),be=(t,e,n,r)=>(sn(t,e,"write to private field"),r?r.call(t,n):e.set(t,n),n),$=(t,e,n)=>(sn(t,e,"access private method"),n);import{r as it,E as vt,x as A}from"./lit-element.Deg-YTNa.js";import{a as ve,o as Ne}from"./map.d1LHv0EW.js";import{n as j}from"./when.BR7zwNJC.js";import{e as xo,a as Ao}from"./addCommonStyleSheet.zOcQQLUh.js";import{d as Jt,c as _o}from"./repeat.D5GkOD5F.js";import{_ as Ie}from"./index.BUIxO2d3.js";import{s as jt,u as ur}from"./static.3li6NsVA.js";import"./toolcool-range-slider.min.BBXDELo7.js";import{o as Mo}from"./orient2d.DArCjZZA.js";import{f as Ce,a as un,b as Co,m as Lo,l as $o}from"./index.BSpBAx16.js";import{g as $r,c as bt}from"./commonjsHelpers.BosuxZz1.js";import"./directive.CvdRHFdJ.js";import"./directive-helpers.oNa9w_hR.js";const So=`
:host {
  display: flex;
...
`;var Te,Sr;class Eo extends it{constructor(){super();q(this,Te);this.filterObject={},this.unstyled=!1}static get properties(){return{filterObject:{attribute:!1,type:Object},unstyled:{type:Boolean}}}render(){return A`
      <style>
        ${!this.unstyled&&Rn}
      </style>
                ...
                <div class="chip-container">
                  <div class="chip-wrapper">
                    <eox-itemfilter-chips
                      ...
                      .controller=${{remove:n=>$(this,P,ci).call(this,n)}}
                    >
                    </eox-itemfilter-chips>
                  </div>
    ...
    `}}P=new WeakSet,oi=function(){setTimeout(()=>this._overlayCleanup=Ya(this))},xn=function(){document.addEventListener("click",this._handleClickOutside),document.addEventListener("focusout",this._handleClickOutside),document.addEventListener("keydown",this._handleKeyDown),$(this,P,oi).call(this)},An=function(){document.removeEventListener("click",this._handleClickOutside),document.removeEventListener("focusout",this._handleClickOutside),document.removeEventListener("keydown",this._handleKeyDown),this._overlayCleanup()},ai=function(n){tl(n,this)},_n=function(n){Qa(n,this)},Mn=function(n){Za(n,this)},li=function(){Ja(this)},Cn=function(n){Xa(n,this)},ci=function(n){ga(n,this)},ui=function(n){Nr(n,this)};customElements.define("eox-itemfilter-container",ql);function Ul(t){const e=t.renderRoot.querySelector("input[type='text']");e.value="",Ue(t.filterObject),t.requestUpdate()}function Wl(t){const e=t.renderRoot.querySelector("input[type='text']");t.isValid=e.checkValidity(),t.filterObject.keys.forEach(n=>{t.filterObject.state[n]=e.value}),t.filterObject.dirty=!0,t.filterObject.stringifiedState=e.value,t.dispatchEvent(new CustomEvent("filter")),e.value===""&&t.reset()}const Ln="ddd, D MMM YYYY HH:mm:ss";function Gl(t){if(t.filterObject=Ue(t.filterObject),t.filterObject){const e=t.querySelector("tc-range-slider"),n=t.filterObject.min,r=t.filterObject.max;e.value1!==n&&(e.value1=n),e.value2!==r&&(e.value2=r)}t.requestUpdate()}function Kl(t,e){const[n,r]=t.detail.values;(n!==e.filterObject.state.min||r!==e.filterObject.state.max)&&([e.filterObject.state.min,e.filterObject.state.max]=[n,r],e.filterObject.dirty=!0),e.filterObject.dirty&&(e.filterObject.stringifiedState=e.filterObject.format==="date"?`${Jt.unix(n).format(Ln)} - ${Jt.unix(r).format(Ln)}`:`${n} - ${r}`),e.dispatchEvent(new CustomEvent("filter")),n===e.filterObject.min&&r===e.filterObject.max?e.reset():e.requestUpdate()}function zl(t,e,n){const r=n.filterObject.format==="date",i=n.filterObject.state[t],o=r?Jt.unix(i).format(Ln):i;return A`<div class="range-${e}">${o}</div>`}function Vl(t){Yl(-1,t),Ue(t.filterObject),t.requestUpdate()}function Yl(t,e){e.selectedItems=[],jn(e),hi(e)}function fi(t,e){const n=e.selectedItems.indexOf(t);n>=0?e.selectedItems=e.selectedItems.filter((r,i)=>i!==n):e.type==="multiselect"?e.selectedItems=[...e.selectedItems,t]:(e.selectedItems=[t],e.showSuggestions=!1),jn(e),hi(e)}function Xl(t,e){t.target instanceof HTMLInputElement&&(e.query=t.target.value,e.showSuggestions=!0)}function Jl(t,e){switch(t.key){case"ArrowDown":e.highlightedIndex=Math.min(e.highlightedIndex+1,e.filteredSuggestions.length-1);break;case"ArrowUp":e.highlightedIndex=Math.max(e.highlightedIndex-1,0);break;case"Enter":e.highlightedIndex>=0&&fi(e.filteredSuggestions[e.highlightedIndex],e);break;case"Escape":e.showSuggestions=!1;break}}function Zl(t,e){(t.has("suggestions")||t.has("query"))&&jn(e)}function Ql(t,e){var r;const n=((r=t.filterObject)==null?void 0:r.sort)||((i,o)=>i.localeCompare(o));return e.sort(n).map(i=>i)}function jn(t){var n,r,i;let e;t.query&&(e=new _t(t.suggestions,{threshold:.4}).search(t.query).map(a=>a.item)),t.filteredSuggestions=Ql(t,e||t.suggestions),(n=t.filterObject)!=null&&n.filterKeys&&(t.filteredSuggestions=(r=t.filterObject)==null?void 0:r.filterKeys.map(o=>`${o}`),t.filterObject.state=(i=t.filterObject)==null?void 0:i.filterKeys.map(o=>`${o}`).reduce((o,a)=>(a in o||(o[a]=void 0),o),t.filterObject.state)),t.highlightedIndex=-1}function hi(t){Object.keys(t.filterObject.state).forEach(e=>{t.filterObject.state[e]=t.selectedItems.includes(e)}),t.filterObject.stringifiedState=Object.keys(t.filterObject.state).filter(e=>t.filterObject.state[e]).join(", ")||"",t.filterObject.dirty=t.filterObject.stringifiedState.length>0,t.dispatchEvent(new CustomEvent("filter")),t.requestUpdate()}function tc(t){Ue(t.filterObject),t.renderRoot.querySelector("eox-itemfilter-spatial-filter").reset(),t.requestUpdate()}function ec(t){t.renderRoot.querySelector("#eox-map").innerHTML="",di(t)}function nc(t,e){e.filterObject.state.mode=t;const n=new CustomEvent("filter",{detail:{[e.filterObject.key]:{}}});e.dispatchEvent(n)}function di(t){const e=t.renderRoot.querySelector("#eox-map");e.innerHTML===""&&(e.innerHTML='<eox-map part="map" style="height: 400px"></eox-map>');const n=t.geometry&&rc(t.geometry),r=Il(t.geometry,n);t.eoxMap=t.renderRoot.querySelector("eox-map"),setTimeout(()=>{t.eoxMap.layers=r;const i=o=>{const a=new CustomEvent("filter",{detail:{geometry:{type:"Polygon",coordinates:o.getGeometry().clone().transform("EPSG:3857","EPSG:4326").getCoordinates()}}});t.dispatchEvent(a)};t.eoxMap.interactions.drawInteraction.on("drawend",o=>{i(o.feature),t.eoxMap.removeInteraction("drawInteraction")}),t.eoxMap.interactions.drawInteraction_modify.on("modifyend",o=>{i(o.features.getArray()[0])})},1e3)}function rc(t){return`data:text/json,${encodeURIComponent(JSON.stringify({type:"FeatureCollection",features:[{type:"Feature",properties:null,geometry:t}]}))}`}var ke;class ic extends it{constructor(){super();q(this,ke,()=>{Wl(this)});Xt(this,"debouncedInputHandler",Ie(G(this,ke),500,{leading:!0}));this.filterObject={},this.unstyled=!1,this.tabIndex=0,this.isValid=!1}static get properties(){return{filterObject:{attribute:!1,type:Object},tabIndex:{attribute:!1,type:Number},unstyled:{type:Boolean},isValid:{state:!0,type:Boolean}}}reset(){Ul(this)}createRenderRoot(){return this}render(){return j(this.filterObject,()=>{var n;return A`
        <style></style>
          ...
          >
            <nav id="${a.id}" class="responsive tiny-space">
              ${j(i.subTitleProperty||i.imageProperty,()=>A`
                  ${j(t.resultType==="cards",()=>St(i.imageProperty,a)?A`
                            <img
                              class="image"
                              src="${St(i.imageProperty,a)}"
                            />
                          `:A`
                            <svg
                              class="image"
      ...
      <section id="section-results">
        ...
        <div id="container-results" class="scroll">
          ...
          ${j(this.config.aggregateResults,()=>Ne(this.resultAggregation.filter(n=>this.aggregateResults(this.results,n).length),n=>A`${j(this.aggregateResults(this.results,n).length===1&&this.config.autoSpreadSingle,()=>A`<div style="margin-left: -8px">
                        ${$(this,Pt,$n).call(this,n)}
                      </div>`,()=>$(this,Pt,gi).call(this,n))}`),()=>$(this,Pt,$n).call(this))}
        </div>
      </section>
    `}}Pt=new WeakSet,$n=function(n){return pi(this,n)},gi=function(n){return oc(n,this)};customElements.define("eox-itemfilter-results",ac);var xt,mi,bi,vi;class yi extends it{constructor(){super();q(this,xt);Xt(this,"debouncedInputHandler",Ie($(this,xt,vi),500,{leading:!0}));this.filterObject={},this.suggestions=[],this.selectedItems=[],this.query="",this.showSuggestions=!1,this.highlightedIndex=-1,this.filteredSuggestions=[],this.type="select",this.unstyled=!1,this.tabIndex=0,this.inlineMode=!1}updated(n){Zl(n,this)}reset(){Vl(this)}firstUpdated(){this.filterObject.state&&(this.selectedItems=Object.keys(this.filterObject.state).map(n=>this.filterObject.state[n]?n:null).filter(n=>!!n),this.filterObject.stringifiedState=this.selectedItems.join(", ")||"",this.requestUpdate())}createRenderRoot(){return this}render(){const n=this.type.includes("multi")?"checkbox":"radio",r=this.filteredSuggestions.length>5?"select-overflow scroll":vt;return A`
      <style>
        :host,
        :root {
      ...
      ${j(this.suggestions.length>10,()=>A`<div class="autocomplete-container">
            <div
                    ...
                    <ul id="filters" class="list no-space">
                      ${Ne(Object.values(this.filters),(r,i)=>A` <li class="no-padding">
                            <eox-itemfilter-expandcontainer
                              ...
                              data-details="${r.key}"
                            >
                              ${$(this,Ut,Di).call(this,r,Mr(i,1))}
                              ${$(this,Ut,Pi).call(this,r,Mr(i,2))}
                            </eox-itemfilter-expandcontainer>
                          </li>`)}
                    </ul>
                  </div>
