var hn=Object.defineProperty;var Bi=i=>{throw TypeError(i)};var pn=(i,t,e)=>t in i?hn(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var O=(i,t,e)=>pn(i,typeof t!="symbol"?t+"":t,e),ni=(i,t,e)=>t.has(i)||Bi("Cannot "+e);var x=(i,t,e)=>(ni(i,t,"read from private field"),e?e.call(i):t.get(i)),A=(i,t,e)=>t.has(i)?Bi("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),vt=(i,t,e,r)=>(ni(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),M=(i,t,e)=>(ni(i,t,"access private method"),e);import{x as h,T as Qt,E as st,r as nt,i as Ae,b as pt,f as fn,u as gn}from"./lit-element.Deg-YTNa.js";import{n as R}from"./when.BR7zwNJC.js";import{c as mn,d as jt}from"./repeat.D5GkOD5F.js";import{e as ar,i as sr,t as Pt}from"./directive.CvdRHFdJ.js";import{f as yn,m as vn}from"./directive-helpers.oNa9w_hR.js";import{o as we,a as bn}from"./map.d1LHv0EW.js";import{e as ei,a as lr}from"./addCommonStyleSheet.zOcQQLUh.js";import{c as Ut,g as Li}from"./commonjsHelpers.BosuxZz1.js";import{_ as wn}from"./index.BUIxO2d3.js";import{g as wi}from"./extent.BK0IhYXB.js";import"./main.DObqTh4C.js";import{L as Ni}from"./Group.C72S98I6.js";import"./toolcool-range-slider.min.BBXDELo7.js";import{s as Sn,l as Si,i as cr,q as xn,t as En,o as $n,p as Tn,f as _n}from"./sequential.Bu6O1RMr.js";import{i as An,s as Cn,a as Ln,j as Fi,k as Ui,n as Dn,f as Vn,o as Mn,p as kn,q as Rn}from"./eo-dash.C8b9HZPs.js";import{h as Pn,p as On,c as oi,o as ai,e as qi,K as In,k as Hn,r as Bn,j as zi,t as Nn}from"./framework.BfoLFm0x.js";import"./browser.DKOFNV7U.js";import"./utils.C66ckBg2.js";import"./index.BSpBAx16.js";/**
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bi=ar(class extends sr{constructor(i){var t;if(super(i),i.type!==Pt.ATTRIBUTE||i.name!=="class"||((t=i.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){var r,n;if(this.st===void 0){this.st=new Set,i.strings!==void 0&&(this.nt=new Set(i.strings.join(" ").split(/\s/).filter(o=>o!=="")));for(const o in t)t[o]&&!((r=this.nt)!=null&&r.has(o))&&this.st.add(o);return this.render(t)}const e=i.element.classList;for(const o of this.st)o in t||(e.remove(o),this.st.delete(o));for(const o in t){const a=!!t[o];a===this.st.has(o)||(n=this.nt)!=null&&n.has(o)||(a?(e.add(o),this.st.add(o)):(e.remove(o),this.st.delete(o)))}return Qt}});class ds{constructor(t){this.cle=t}render(){const t=this.cle.titleText?h`<p class="legend-title">${this.cle.titleText}</p>`:"",e={hidden:this.cle.scaleType==="categorical"},r={hidden:this.cle.scaleType!=="categorical","categorical-container":!0};return h`<div
      class="cle-container"
